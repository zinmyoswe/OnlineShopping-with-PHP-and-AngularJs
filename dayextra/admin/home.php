        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <?php
                  include('../confs/config.php');
                  $orders = mysqli_query($mysqli,"SELECT * FROM orders ORDER BY order_id DESC LIMIT 4"); ?>
                  <ul class="orders">
                  ...
                  <tr>
                    ...
                    <span class="label label-warning">Ordering</span>
                    <?php }else if($order['status'] == 2){ ?>
                      <span class="label label-primary">Waiting Payment</span>
                      <?php }else{ ?>
                        <span class="label label-success">Delievered</span>
                      <?php } ?> 
                    </td>
                    <td>
                    </td>
            ...
            <div class="box-footer clearfix">
              ...
              <a href="order2.php" class="btn btn-sm btn-default btn-flat pull-right">View All Orders</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
 ...
 <?php while($row = mysqli_fetch_assoc($result)): ?>
                <li class="item">
                  <div class="product-img">
                    <img src="cover/<?php echo $row['cover']; ?>" alt="Product Image">
                  </div>
                    ...
                    <a href="javascript:void(0)" class="product-title"><?php echo $row['product_name']; ?>
                      <span class="label label-warning pull-right">$<?php echo $row['price']; ?></span></a>
                        <span class="product-description">
                          by <small><?php echo $row['supplier_name']; ?></small>
                        </span>
                  </div>
                </li>
              <?php endwhile; ?>
            ...
            <!-- /.box-body -->
            <div class="box-footer text-center">
              <a href="product_display2.php" class="uppercase">View All Products</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
